...
const SEQUENCE = ['m', 'o', 'o', 'd'];
const STORAGE_KEY = 'mood_unlocked';

export function useMoodSequence(paperState: PaperState) {
  ...
  return { isUnlocked, progress, flashIndex, exitGame };
}
